...
const Grid = () => {
  ...
  const {
    ...
    startCell: state.grid.startCell,
    goalCell: state.grid.goalCell,
    selectedAlgorithm: state.pathfind.selectedAlgorithm,
    selectedGridType: state.pathfind.selectedGridType,
    selectedCellType: state.pathfind.selectedCellType,
    clearedGrid: state.pathfind.clearedGrid,
    clearObstacles: state.pathfind.clearObstacles,
    clearPath: state.pathfind.clearPath,
    selectedHeuristic: state.settings.selectedHeuristic,
    selectedSpeedType: state.settings.selectedSpeedType,
    selectedHeuristicWeight: state.settings.selectedHeuristicWeight,
    diagonalMovement: state.settings.diagonalMovement,
  }));
