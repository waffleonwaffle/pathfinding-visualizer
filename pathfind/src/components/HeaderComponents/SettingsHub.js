      ...
      <Menu.Dropdown className="settings">
        <section className="heuristic-grid">
          ...
          <Radio.Group defaultValue={selectedHeuristic}>
            ...
            ></HeuristicOption>
            <HeuristicOption
              heuristicLink={"https://en.wikipedia.org/wiki/Chebyshev_distance"}
              handleHeuristicChange={handleHeuristicChange}
        ...
        <section className="heuristic-weight-grid">
          ...
          <Slider
            ...
            defaultValue={selectedHeuristicWeight}
            onChange={(heuristicWeight) =>
              dispatch(setHeuristicWeight(heuristicWeight))
            }
            min={0}
            max={10}
            step={0.001}
            value={selectedHeuristicWeight.toFixed(3)}
          ></Slider>
        </section>
        <section className="movement-grid">
          <Checkbox
            ...
            onChange={toggleDiagonalMovement}
            label="8-Directional Movement"
          />
        </section>
